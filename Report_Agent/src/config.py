...
BBC_ARTICLE_URLS = [
    # BBC URLs are currently commented out because some previously public
    # articles now return 404s. The system is designed so that additional
    # trusted sources (BBC Technology, ICO, Ofcom) can be added here
